 ...
 **/
export declare function useDatatableLifecycle({ initialSort, initialFilterText, initialPageNumber, onFilterCallback, onPaginateCallback, onSortCallback, onRowsPerPageChangeCallback, onSort, onFilter, rowsPerPage, rowsPerPageOption, async, tableHeaders, classes, tableBody, labels, Components, onRowClick }: DatatableProps): {
    data: any[];
