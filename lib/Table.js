...
function useDatatableLifecycle(_a) {
    var initialSort = _a.initialSort, initialFilterText = _a.initialFilterText, initialPageNumber = _a.initialPageNumber, onFilterCallback = _a.onFilterCallback, onPaginateCallback = _a.onPaginateCallback, onSortCallback = _a.onSortCallback, onRowsPerPageChangeCallback = _a.onRowsPerPageChangeCallback, onSort = _a.onSort, onFilter = _a.onFilter, rowsPerPage = _a.rowsPerPage, rowsPerPageOption = _a.rowsPerPageOption, async = _a.async, tableHeaders = _a.tableHeaders, _b = _a.classes, classes = _b === void 0 ? {} : _b, tableBody = _a.tableBody, _c = _a.labels, labels = _c === void 0 ? {} : _c, Components = _a.Components, onRowClick = _a.onRowClick;
    ...
    var _d = react_1.useState(function () {
        ...
        return {
            ...
            currentPage: initialPageNumber !== null && initialPageNumber !== void 0 ? initialPageNumber : 1,
            filterText: initialFilterText !== null && initialFilterText !== void 0 ? initialFilterText : ''
        };
    ...
    function onSortChange(nextProp) {
        if (async && async.onSort) {
            ...
            onSortCallback && onSortCallback(nextSort_1);
        }
    }
    var data = tableBody;
    var maxPage;
